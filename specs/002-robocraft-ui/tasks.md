...
- [X] T001 Install Google Sans Code font and configure font loading in src/css/fonts.css
...
- [X] T072 Create Interactive3DRobotPreview component in src/components/Interactive3DRobotPreview.jsx
- [X] T073 [P] Implement 3D rotating humanoid robot model with cursor-tracking rotation (follows mouse movement) in src/components/Interactive3DRobotPreview.jsx
- [X] T074 [P] Implement showing actual robot learners will build/simulate in src/components/Interactive3DRobotPreview.jsx
- [X] T075 Implement subtle animation (breathing motion, eye glow, joint articulation) in src/components/Interactive3DRobotPreview.jsx
- [X] T076 Add hover states: Different parts highlight with tooltips ("Servo motors", "AI vision system", "Balance sensors") in src/components/Interactive3DRobotPreview.jsx
- [X] T077 Implement positioning on the right side of hero section in src/components/Interactive3DRobotPreview.jsx
- [X] T078 Fix hero section layout: content on left without overlap with robot on right in src/components/HeroSection.jsx
- [X] T079 Integrate Interactive 3D Robot Preview into HeroSection component on right side in src/components/HeroSection.jsx
...
- [X] T081 Implement neon orange hover outline effects with glow for ModuleCard component in src/components/ModuleCard.jsx
- [X] T082 Implement neon orange hover outline effects with glow for HardwareTierCard component in src/components/HardwareTierCard.jsx
- [X] T083 [P] Implement neon orange hover outline effects with glow for other card components in src/components/
- [X] T084 Add consistent transition effects with glow for hover states in src/css/industrial-styles.module.css
- [X] T085 Ensure hover effects meet accessibility standards in src/components/
...
- [X] T099 Configure Google Sans Code font loading in src/css/fonts.css with proper fallbacks
- [X] T100 Update all homepage typography to use Google Sans Code in src/css/custom.css
- [X] T101 Update all docs typography to use Google Sans Code in src/css/custom.css
...
- [X] T104 Implement Dark mode color palette (black #08090d primary, orange #f97316 secondary, white minimal) in src/css/custom.css
...
- [X] T111 Add GitHub link to navbar pointing to github.com/sheikh-mohammad in docusaurus.config.js
- [X] T112 Ensure search bar is properly integrated in navbar (Algolia configuration) in docusaurus.config.js
- [X] T113 Update navbar items (LEARN FREE, MODULES, TECHNOLOGY) to orange color (#f97316) in src/css/custom.css
- [X] T114 Add same logo to both homepage and docs navbar in docusaurus.config.js
- [X] T115 Ensure navbar design is unified across homepage and docs in src/css/custom.css
...
- [X] T117 Update footer structure with Docs section (Textbook link) in src/components/Footer.jsx
...
- [X] T131 Create prominency effects CSS module with elevation levels in src/css/prominency.module.css
- [X] T132 Define shadow styles for different elevation levels in src/css/prominency.module.css
- [X] T133 Apply prominency effects to all cards on homepage in src/components/
- [X] T134 Apply prominency effects to navigation and footer in src/components/
- [X] T135 Apply prominency effects to docs pages in src/css/custom.css
